...
<!-- ============================================================
     ...
     VERSION APPLICATION : v668
     VERSION APPS SCRIPT REQUISE : v155
     Mis à jour le : 28/08/2026 à 16:22
     ...
     Ce fichier appelle 54 modules dans le dossier app/.
...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .rec-btn.recording{background:#1F5C99; border-color:#1F5C99; color:#fff;
...
<div class="wrap">
  <header>
    ...
    <!-- Le guide s'ouvre dans un autre onglet : une question posée
         au milieu d'un cours ne doit pas coûter l'enregistrement.
         Le ?v= suit celui des modules, sinon le navigateur ressort
         l'ancien guide de son cache. -->
    <a id="guideBtn" href="guide.html?v=668" target="_blank" rel="noopener"
       title="Guide d'utilisation" style="display:none;
            ...
            font-size:18px;cursor:pointer;flex-shrink:0;text-decoration:none;
            align-items:center;justify-content:center;">📘</a>

    <!-- Vérifier que le moniteur a bien la dernière version :
         un écran figé sur une vieille version explique beaucoup
         de « ça ne marche pas ». -->
    <button id="versionBtn" title="Vérifier la version" style="display:none;
            margin-left:8px;background:transparent;border:1px solid var(--line);
            color:var(--cream);border-radius:10px;width:44px;height:44px;
  ...
  (function(){
    ...
    function essayer(){
      ...
      var attendus = ['ec-etat.js','ec-modeles.js','ec-consignes.js','ec-noyau.js',
        ...
        'ec-onglets.js','ec-depart.js','ec-demarrage.js'];
  ...
  <div id="recordView" data-onglet="cours" data-section="cours" data-vue="cours">
    <div class="card">
      ...
      <!-- Ce qui a été préparé pour ce cours, s'il y a une préparation -->
      <div id="preparationEleve" style="display:none;margin-bottom:14px;"></div>
      ...
      <label for="eleveMessenger">💬 Messenger de l'élève</label>
      <div style="display:flex;gap:8px;align-items:center;">
        <input type="text" id="eleveMessenger" autocomplete="off"
               placeholder="Lien ou pseudo — retenu pour la suite"
               style="flex:1;min-width:0;margin:0;">
        <a id="eleveMessengerLien" href="#" target="_blank" rel="noopener"
           class="btn btn-secondary" title="Ouvrir la conversation"
      ...
      <div class="hint" id="eleveMessengerEtat">
        Saisi une fois, il est retenu : tous les moniteurs le retrouveront ici.
      </div>
      ...
      <div id="zoneManuel">
        <button class="btn" id="manuelBtn"
                style="margin-top:12px;background:var(--ambre);
                       color:var(--sur-ambre);">✍️ Bilan à remplir à la main</button>
    ...
    <button class="btn" id="finishBtn"
            style="display:none;margin-top:46px;padding:20px;font-size:16px;
                   background:#9E3B32;border:2px solid #9E3B32;color:#FFFFFF;
  ...
  <div class="card" data-section="bureau_permis" data-vues="pasprets envisager preppermis resultats" data-onglet="permis">
    ...
    <div data-section="bureau_places">
      ...
      <details data-vue="pasprets" class="volet-liste" style="margin-bottom:12px;">
      ...
      <details data-vue="envisager" class="volet-liste" style="margin-bottom:14px;">
    ...
    <details data-vue="pasprets" class="volet-liste" style="margin-top:16px;" data-section="bureau_permis">
    ...
    <details data-vue="pasprets" class="volet-liste" style="margin-top:16px;padding-top:14px;border-top:1px solid var(--line);">
    ...
    <details data-vue="envisager" class="volet-liste" style="margin-top:20px;padding-top:16px;border-top:1px solid var(--line);" data-section="bureau_permis">
  ...
  <div class="card" data-section="rappels" data-vue="rappels" data-onglet="eleves">
    ...
    <div class="contenu-tiroir">
      <div style="font-size:12px;color:var(--muted);margin-bottom:12px;line-height:1.5;">
        Dépose la capture de ton planning : l'IA en tire la liste des cours,
        retrouve les élèves dans le répertoire et prépare un SMS pour chacun.
      ...
      <div style="display:flex;gap:8px;margin-bottom:14px;">
        ...
        <button class="btn btn-secondary" id="rappelModePlanning"
                style="flex:1;padding:12px;font-size:14px;margin:0;">📷 Depuis le planning</button>
      ...
      <div id="rappelPlanning" style="display:none;">
      <label for="rappelFichier">📷 Capture(s) du planning</label>
      <input type="file" id="rappelFichier" accept="image/*" multiple
             style="width:100%;background:var(--navy);border:1px solid var(--line);
                    ...
                    margin-bottom:10px;">
      <button class="btn btn-primary" id="rappelLire">🔎 Lire le planning</button>
      <div id="rappelZone" style="margin-top:14px;">
        <div class="empty">Dépose une capture, puis appuie sur Lire le planning.</div>
      </div>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-section="eleves" data-vue="eleves" data-onglet="eleves">
    <h2 class="section-title">👥 Répertoire des élèves</h2>
    <div class="contenu-tiroir">
      <div style="font-size:12px;color:var(--muted);margin-bottom:12px;line-height:1.5;">
        ...
        <br><em>La suppression complète d'un élève reste réservée aux administrateurs.</em>
      </div>
  ...
  <div class="card" data-section="bureau_messages" data-vue="messages" data-onglet="gestion">
    <h2 class="section-title">📨 Messages aux moniteurs <span class="compteur" id="cptMessages"></span></h2>
    <div class="contenu-tiroir">
  ...
  <div class="card" data-section="textes" data-vue="textes" data-onglet="outils">
    <h2 class="section-title">📄 Textes types</h2>
    <div class="contenu-tiroir">
      <div style="font-size:12px;color:var(--muted);margin-bottom:12px;line-height:1.5;">
        Les textes que vous envoyez souvent : message du groupe Messenger le jour du permis,
        félicitations après obtention, examen blanc, rendez-vous post-permis, départ.
        Rédigez-les une fois ici, l'application les reprendra à votre place.
  ...
  <div class="card" data-section="stats" data-vue="stats" data-onglet="outils">
    ...
    <div class="contenu-tiroir">
      ...
      <div class="duo">
        <div>
          <label for="statsPeriode">Période</label>
          <select id="statsPeriode">
      ...
      <button class="btn btn-primary" id="statsBtn">📊 Calculer</button>
      <div id="statsZone" style="margin-top:14px;">
        <div class="empty">Appuie sur Calculer.</div>
      </div>
    </div>
  </div>
  ...
  <div class="card" data-section="historique" data-vue="historique" data-onglet="outils">
    <h2 class="section-title">📚 Historique des cours</h2>
    <div class="contenu-tiroir">
      <div style="font-size:12px;color:var(--muted);margin-bottom:12px;line-height:1.5;">
        Ce qui s'enregistre en ce moment, et tout ce qui a été enregistré.
      </div>
      <div id="historiqueZone"><div class="empty">Chargement…</div></div>
    </div>
  </div>
  ...
  <div class="card" data-section="paiement" data-vue="paiement" data-onglet="outils">
  ...
  <div class="card" id="adminCard" data-vue="admin" data-onglet="gestion" style="display:none;">
    ...
    <details style="margin-top:20px;padding-top:16px;border-top:1px solid var(--line);">
      ...
      <div style="margin-top:12px;">
        <div style="font-size:13px;color:var(--muted);line-height:1.5;margin-bottom:12px;">
          Recompte les leçons des <strong>cours préparés</strong> et corrige ceux dont
          le numéro est faux. La liste s'affiche d'abord : rien n'est modifié
        ...
        <button class="btn btn-secondary" id="reparLeconsBtn">🔢 Vérifier les numéros de leçon</button>
        ...
        <div style="font-size:12px;color:var(--muted);margin:18px 0 12px;line-height:1.5;
          ...
          Remet à la forme actuelle la ligne <strong>« examen officiel »</strong> des
          notes écrites avant que cette mise en forme existe — majuscules, gras,
          et la couleur qui va avec (rouge quand la date est posée, bleu quand
          elle manque). Le reste de chaque note n'est pas touché, et seule la
          note la plus récente de chaque élève est reprise : les bilans plus
          anciens gardent ce qu'ils disaient. La liste s'affiche d'abord.
        </div>
        <button class="btn btn-secondary" id="reparNotesBtn">🎨 Vérifier les lignes d'examen</button>
  ...
  <div class="modal">
    ...
    <div class="btn-row">
      ...
      <button class="btn" id="confirmGen"
              style="background:#9E3B32;border:2px solid #9E3B32;color:#FFFFFF;
...
<div class="toast" id="toast"></div>
  ...
  <script src="app/ec-etat.js?v=668"></script>
<script src="app/ec-modeles.js?v=668"></script>
<script src="app/ec-consignes.js?v=668"></script>
<script src="app/ec-noyau.js?v=668"></script>
<script src="app/ec-vocal.js?v=668"></script>
<script src="app/ec-reseau.js?v=668"></script>
<script src="app/ec-manuel.js?v=668"></script>
<script src="app/ec-fenetres.js?v=668"></script>
<script src="app/ec-questionnaire.js?v=668"></script>
<script src="app/ec-permis.js?v=668"></script>
<script src="app/ec-prepares.js?v=668"></script>
<script src="app/ec-bureau.js?v=668"></script>
<script src="app/ec-places.js?v=668"></script>
<script src="app/ec-listes.js?v=668"></script>
<script src="app/ec-permis-listes.js?v=668"></script>
<script src="app/ec-postpermis.js?v=668"></script>
<script src="app/ec-textes.js?v=668"></script>
<script src="app/ec-correction.js?v=668"></script>
<script src="app/ec-bilans.js?v=668"></script>
<script src="app/ec-ecran.js?v=668"></script>
<script src="app/ec-version.js?v=668"></script>
<script src="app/ec-paie.js?v=668"></script>
<script src="app/ec-flotte.js?v=668"></script>
<script src="app/ec-solo.js?v=668"></script>
<script src="app/ec-handicap-pdf.js?v=668"></script>
<script src="app/ec-moto.js?v=668"></script>
<script src="app/ec-remorque.js?v=668"></script>
<script src="app/ec-arriereplan.js?v=668"></script>
<script src="app/ec-placesbe.js?v=668"></script>
<script src="app/ec-codeamenage.js?v=668"></script>
<script src="app/ec-financements.js?v=668"></script>
<script src="app/ec-eval-aac.js?v=668"></script>
<script src="app/ec-postes.js?v=668"></script>
<script src="app/ec-tarifs.js?v=668"></script>
<script src="app/ec-evaluation.js?v=668"></script>
<script src="app/ec-paiement.js?v=668"></script>
<script src="app/ec-handicap.js?v=668"></script>
<script src="app/ec-code.js?v=668"></script>
<script src="app/ec-proccorriger.js?v=668"></script>
<script src="app/ec-sessions.js?v=668"></script>
<script src="app/ec-notifs.js?v=668"></script>
<script src="app/ec-ecoutes.js?v=668"></script>
<script src="app/ec-taches.js?v=668"></script>
<script src="app/ec-memoire.js?v=668"></script>
<script src="app/ec-historique.js?v=668"></script>
<script src="app/ec-rappels.js?v=668"></script>
<script src="app/ec-segments.js?v=668"></script>
<script src="app/ec-sms.js?v=668"></script>
<script src="app/ec-stats.js?v=668"></script>
<script src="app/ec-messenger.js?v=668"></script>
<script src="app/ec-journal.js?v=668"></script>
<script src="app/ec-depart.js?v=668"></script>
<script src="app/ec-onglets.js?v=668"></script>
<script src="app/ec-demarrage.js?v=668"></script>
